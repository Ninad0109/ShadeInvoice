...
class LightModeColors {
  ...
  static const lightOnPrimaryContainer = Color(0xFF0D4E12);
...
class DarkModeColors {
  ...
  static const darkOnPrimary = Color(0xFF1E1E1E);
  static const darkPrimaryContainer = Color(0xFF2C2C2C);
  static const darkOnPrimaryContainer = Color(0xFFEAEAEA);
  static const darkSecondary = Color(0xFF4ADE80);
  static const darkOnSecondary = Color(0xFF1E1E1E);
  static const darkTertiary = Color(0xFFEAEAEA);
  static const darkOnTertiary = Color(0xFF1E1E1E);
  static const darkError = Color(0xFFFF6B6B);
  static const darkOnError = Color(0xFF1E1E1E);
  static const darkErrorContainer = Color(0xFF2C2C2C);
  static const darkOnErrorContainer = Color(0xFFFFCDD2);
  static const darkInversePrimary = Color(0xFF4ADE80);
  ...
  static const darkInputBackground = Color(0xFF3A3A3A);
}
...
ThemeData get darkTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    filled: true,
    fillColor: DarkModeColors.darkInputBackground,
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
    ...
    hintStyle: TextStyle(
      color: DarkModeColors.darkOnSurface.withValues(alpha: 0.6),
    ),
